...
def load_page() -> None:
    ...
    model_components.add_portfolio_returns_graphs(monte_carlo_model.portfolio_returns)

    # add download button
    model_components.add_download_button(monte_carlo_model.portfolio_returns)