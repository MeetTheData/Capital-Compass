...
def load_sidebar() -> None:
    ...
    sidebar_components.load_sidebar_dropdown_stocks(portfo_tab)
    sidebar_components.load_sidebar_stocks(portfo_tab,
    ...
    sidebar_components.load_sidebar_risk_model(model_tab)
