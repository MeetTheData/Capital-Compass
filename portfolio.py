...
def load_page():
    ...
    with col1_summary:
        portfolio_components.load_portfolio_performance_cards(
    ...
    with col2_pie:
        portfolio_components.load_portfolio_summary_pie()

    # load portfolio summary
    portfolio_components.load_portfolio_summary_table()

    # load investment preview
    st.subheader("Investment Performance Summary - Since Purchase")
    portfolio_components.load_portfolio_preview(no_stocks=no_stocks)